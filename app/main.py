        ...
        while i < len(args):
            if args[i] in {">", "1>"}:
                if i + 1 < len(args):
                    ...
                    if not os.path.exists(os.path.dirname(redirect_stdout)):
                ...
                if i + 1 < len(args):
                    ...
                    if not os.path.exists(os.path.dirname(append_stdout)):
                ...
                if i + 1 < len(args):
                    ...
                    if not os.path.exists(os.path.dirname(redirect_stderr)):
                ...
                if i + 1 < len(args):
                    ...
                    if not os.path.exists(os.path.dirname(append_stderr)):
...
def handle_command(command, args, redirect_stdout, redirect_stderr, append_stdout, append_stderr):
    if command == "exit":
        execute_exit(args)
    elif command == "echo":
